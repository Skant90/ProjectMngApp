...
export default function TaskCreate({ projects, users, tags, default_project_id }: Props) {
    const { data, setData, post, processing, errors } = useForm({
        project_id: default_project_id?.toString() ?? '',
        title: '',
        description: '',
        status: 'todo',
        priority: 'medium',
    ...
    return (
        <AppLayout title="Nowe zadanie">
            <Head title="Nowe zadanie" />
            <div className="p-6 max-w-2xl mx-auto space-y-5">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-xl font-bold text-gray-900 dark:text-white">Nowe zadanie</h1>
                </div>
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div className="flex justify-end gap-3 pt-2">
                                <Button variant="outline" type="button" asChild>
                                    <Link href={route('tasks.index')}>Anuluj</Link>
                                </Button>
                                <Button type="submit" disabled={processing}>
                                    {processing ? 'Zapisywanie...' : 'Utwórz zadanie'}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
